<!--More Projects-->
<div class="container-fluid morepjs">
	<div class="container">
		<h3>All Projects</h3>
		<div class="row">
			<div class="col-md">
...
<!--Footer-->
<footer class="container-fluid my-4 p-3">
	<div class="row">
		<div class="col-lg-3 m-auto">
			<h5 class="text-center"><mark>Mr. Rymer</mark></h5>
		</div>
		<div class="col-lg-9">
			<ul>
				<a href="index.php">
...
<script src="js/app/mrrymer.js" type="text/javascript"></script>
