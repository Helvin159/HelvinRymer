	...
	<div class="container-fluid section2 p-5" id="myskills">
		...
		<div class="container p-4 skills">
			...
			<div class="container">
				<h5>JavaScript</h5>
				<div class="progress my-2">
					<div class="progress-bar bg-danger progress-bar-animated progress-bar-striped" role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
				</div>
			</div>
			<div class="container">
				<h5>AngularJS</h5>
